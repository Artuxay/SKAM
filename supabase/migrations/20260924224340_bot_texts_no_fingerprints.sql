-- СКАМ — подсказки бота без сверки ключей по эмодзи.
--
-- Сверку отпечатков ключей из приложения убрали, поэтому бот больше не предлагает сравнивать эмодзи
-- и говорит «пароль шифрования» вместо «ключ шифрования» в профиле. Добавлено, что стикеры,
-- голосовые и кружочки в личных чатах и группах тоже шифруются. Остальные ответы — как в bot_help_merge.
