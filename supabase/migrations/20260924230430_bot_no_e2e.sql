-- СКАМ — в чате с ботом снова без сквозного шифрования.
--
-- Сквозное шифрование остаётся только в обычных чатах — личных и группах (там шифруется всё,
-- в том числе фото и видео). Отменяем e2e_bot_chat и bot_e2e_media_only: ключи чатов снова
-- заводятся только в личных чатах и группах, а фразы бота — как в bot_texts_no_fingerprints.
